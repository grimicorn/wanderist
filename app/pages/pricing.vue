  ...
  <div>
    ...
    <div class="table-wrap" data-reveal>
      <table class="cmp">
        <thead>
          <tr>
            <th class="thd thd--feat">
              <span class="thd__name">Features</span>
            </th>
            <th class="thd">
              <div class="thd__name">Drifter</div>
              <div class="thd__price">
                $0<span class="thd__per">/forever</span>
              </div>
              <div class="thd__cta">
                <NuxtLink
                  to="/login"
        ...
        <tbody>
          <tr class="cat-row">
            <td colspan="4">Places &amp; trips</td>
          </tr>
          <tr class="feat-row">
            <td>Places pinned</td>
            <td>25</td>
            <td class="pop">Unlimited</td>
            <td>Unlimited</td>
          </tr>
          <tr class="feat-row">
            <td>Active trips</td>
          ...
          <tr class="feat-row">
            ...
            <td><CheckIcon /></td>
            <td class="pop"><CheckIcon /></td>
            <td><CheckIcon /></td>
          </tr>
          <tr class="feat-row">
            <td>GPX route import / export</td>
            <td><DashCell /></td>
            <td class="pop"><DashCell /></td>
            <td><CheckIcon /></td>
          </tr>

          <tr class="cat-row">
            <td colspan="4">Photos &amp; media</td>
          </tr>
          <tr class="feat-row">
            <td>Photo storage</td>
            <td>100</td>
          ...
          <tr class="feat-row">
            <td>Instagram sync</td>
            <td><DashCell /></td>
            <td class="pop"><CheckIcon /></td>
            <td><CheckIcon /></td>
          </tr>
          <tr class="feat-row">
            <td>Original-resolution backup</td>
            <td><DashCell /></td>
            <td class="pop"><DashCell /></td>
            <td><CheckIcon /></td>
          </tr>
          ...
          <tr class="cat-row">
            <td colspan="4">Sharing &amp; support</td>
          </tr>
          <tr class="feat-row">
            <td>Public traveler profile</td>
            <td><DashCell /></td>
            <td class="pop"><DashCell /></td>
            <td><CheckIcon /></td>
          </tr>
          <tr class="feat-row">
            <td>Collaborative trips</td>
            <td><DashCell /></td>
            <td class="pop"><DashCell /></td>
            <td><CheckIcon /></td>
          </tr>
...
.cmp-head .topo {
  opacity: calc(var(--topo-opacity) * 1.3);
}
.cmp-head__in {
  position: relative;
  z-index: 2;
...
tbody tr.feat-row td:first-child {
  text-align: left;
  color: var(--ink);
  font-weight: 500;
}
tbody tr.feat-row td.pop {
  background: color-mix(in srgb, var(--accent-weak) 55%, transparent);
}
.ck {
  color: var(--accent);
  width: 17px;
